...
const steps: Step[] = [
  {
    number: '01',
    title: 'Compile to LLVM IR',
    description: 'Submit C/C++ source and compile it with clang++ down to LLVM IR.',
  },
  {
    number: '02',
    title: 'Lower to Machine IR',
    description: 'Lower the IR to Machine IR with llc, targeting x86-64 or AArch64.',
  },
  {
    number: '03',
    title: 'Run the Energy Pass',
    description: 'The out-of-tree MachineFunctionPass classifies every instruction into a weighted cost bucket.',
  },
  {
    number: '04',
    title: 'Inspect the Results',
    description: 'Explore function-, block-, and source-annotated energy costs in the dashboard.',
  },
]
      ...
      <Gutter>
        ...
        >
          ...
          <p className="text-lg text-neutral-400">
            From raw source to source-annotated energy results in a few easy steps.
          </p>
        </motion.div>
